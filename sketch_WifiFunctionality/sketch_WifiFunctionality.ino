...
/*
Defines the ssid_Router, password_Router for WiFi
Defines the host, author_Email, author_Password for SMTP 
*/
#include "secrets.h"
...
void setup() {
  ...
  // Mail Connection setup (Copied from examples)
  // ----------------------------
  ...
  */
  ...
  message.addRecipient(F("Admin"), host);
